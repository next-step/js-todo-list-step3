...
export const todoAppContainerTemplate = (memberId, memberName) => {
    return `<li id="${memberId}" class="todoapp-container">
                ...
                <div class="count-container">
                    ...
                    <li> <a id="all" class="all selected"> 전체보기 </a> </li>
                    <li> <a id="priority" class="priority"> 우선 순위 </a> </li>
                    <li> <a id="active" class="active"> 해야할 일 </a> </li>
                    <li> <a id="completed" class="completed"> 완료한 일 </a> </li>
                    </ul>
