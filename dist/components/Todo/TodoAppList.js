import { TODO_APP_LIST_CONTAINER, TODO_APP_CONTAINER, FLEX_COLUMN_CONTAINER, ADD_USER_BTN_CONTAINER } from "../../utils/data.js";
...
export default function TodoAppList({ elementId }) {
  ...
  this.clickHandler = async () => {
    ...
    if (result) {
      ...
      const newTeam = await API.getOneTeam(this.currentTeamID);
      this.setState(newTeam);
    }
  };

  this.render = () => {
    this.$todoAppList.innerHTML = "";
    this.renderAddBtn();
